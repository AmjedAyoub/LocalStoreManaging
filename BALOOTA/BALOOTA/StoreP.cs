...
namespace BALOOTA
{
    public partial class StoreP : Form
    {
        public StoreP()
        {
            InitializeComponent();
        ...
        public void StoreP_Load(object sender, EventArgs e)
        {
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
            ...
            if (textBox1.Text != "")
            {
                if (textBox7.Text != "")
                {
                    if (float.Parse(textBox7.Text) >= 0)
                    {
                        ...
                        if (float.Parse(textBox7.Text) <= reg1)
                        {
                            Program.mysignin.Show();
                            Program.mysignin.Signin_Load(sender, e);
                            string ww = "StorePP";
        ...
        public void StorePP(bool ok, string n)
        {
            if (ok)
            {
                ...
                cmd.Parameters.AddWithValue("@textBox3", "لقد تم دفع دين محل" + Environment.NewLine + "  رمز الحركة  " + textBox1.Text + "  الاسم   " + textBox4.Text + "  التاريخ  " + textBox3.Text + "  القيمة  " + textBox7.Text );
                cmd.Parameters.AddWithValue("@textBox4", "UP");
                con.Open();
                SqlDataReader dr2 = cmd.ExecuteReader();

                MessageBox.Show("لقد تم الدفع بنجاح");
                textBox1.Text = "";
                textBox2.Text = "";
                textBox3.Text = "";
                textBox4.Text = "";
