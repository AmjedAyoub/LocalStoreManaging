...
namespace BALOOTA
{
    public partial class CoDebt : Form
    {
        public CoDebt()
        {
            InitializeComponent();
        ...
        public void CoDebt_Load(object sender, EventArgs e)
        {
            ...
            conn39.Open();
            SqlCommand cmd39 = new SqlCommand("select * from StoreDebt", conn39);
            string iitem = "";
        ...
        public void Codebt()
        {
            ...
            try
            {
                if (comboBox3.Text != "" && comboBox3.Text != "الكل" && textBox8.Text == "" && textBox10.Text == "")
                {
                    ...
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("select * from StoreDebt", conn);
                    ...
                    while (dr.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1,false, dr["Id"].ToString(), dr["idPurchase"].ToString(), dr["Date"].ToString(), dr["Name"].ToString(), dr["InvNo"].ToString(), dr["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.Text != "" && comboBox3.Text != "الكل" && textBox8.Text == "" && textBox10.Text != "")
                {
                    ...
                    while (dr4.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr4["Id"].ToString(), dr4["idPurchase"].ToString(), dr4["Date"].ToString(), dr4["Name"].ToString(), dr4["InvNo"].ToString(), dr4["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.Text != "" && comboBox3.Text != "الكل" && textBox8.Text != "" && textBox10.Text == "")
                {
                    ...
                    con5.Open();
                    SqlCommand cmd5 = new SqlCommand("select * from StoreDebt", con5);
                    ...
                    while (dr5.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr5["Id"].ToString(), dr5["idPurchase"].ToString(), dr5["Date"].ToString(), dr5["Name"].ToString(), dr5["InvNo"].ToString(), dr5["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.Text != "" && comboBox3.Text != "الكل" && textBox8.Text != "" && textBox10.Text != "")
                {
                    ...
                    con6.Open();
                    SqlCommand cmd6 = new SqlCommand("select * from StoreDebt", con6);
                    ...
                    while (dr6.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr6["Id"].ToString(), dr6["idPurchase"].ToString(), dr6["Date"].ToString(), dr6["Name"].ToString(), dr6["InvNo"].ToString(), dr6["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.SelectedItem.ToString() == "الكل" && textBox8.Text == "" && textBox10.Text != "")
                {
                    ...
                    con7.Open();
                    SqlCommand cmd7 = new SqlCommand("select * from StoreDebt", con7);
                    ...
                    while (dr7.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr7["Id"].ToString(), dr7["idPurchase"].ToString(), dr7["Date"].ToString(), dr7["Name"].ToString(), dr7["InvNo"].ToString(), dr7["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.SelectedItem.ToString() == "الكل" && textBox8.Text != "" && textBox10.Text == "")
                {
                    ...
                    con8.Open();
                    SqlCommand cmd8 = new SqlCommand("select * from StoreDebt", con8);
                    ...
                    while (dr8.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr8["Id"].ToString(), dr8["idPurchase"].ToString(), dr8["Date"].ToString(), dr8["Name"].ToString(), dr8["InvNo"].ToString(), dr8["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.SelectedItem.ToString() == "الكل" && textBox8.Text != "" && textBox10.Text != "")
                {
                    ...
                    con9.Open();
                    SqlCommand cmd9 = new SqlCommand("select * from StoreDebt", con9);
                    ...
                    while (dr9.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr9["Id"].ToString(), dr9["idPurchase"].ToString(), dr9["Date"].ToString(), dr9["Name"].ToString(), dr9["InvNo"].ToString(), dr9["Amount"].ToString());
                            row1++;
                        }
                    }
                ...
                else if (comboBox3.SelectedItem.ToString() == "الكل" && textBox8.Text == "" && textBox10.Text == "")
                {
                    ...
                    con10.Open();
                    SqlCommand cmd10 = new SqlCommand("select * from StoreDebt", con10);
                    ...
                    while (dr10.Read())
                    {
                        dataGridView1.Rows.Insert(row1, false, dr10["Id"].ToString(), dr10["idPurchase"].ToString(), dr10["Date"].ToString(), dr10["Name"].ToString(), dr10["InvNo"].ToString(), dr10["Amount"].ToString());
                        row1++;
                ...
                else if (comboBox3.Text == "" && comboBox3.Text != "الكل" && textBox8.Text != "" && textBox10.Text == "")
                {
                    ...
                    con1.Open();
                    SqlCommand cmd1 = new SqlCommand("select * from StoreDebt", con1);
                    ...
                    while (dr1.Read())
                    {
                        ...
                        {
                            dataGridView1.Rows.Insert(row1, false, dr1["Id"].ToString(), dr1["idPurchase"].ToString(), dr1["Date"].ToString(), dr1["Name"].ToString(), dr1["InvNo"].ToString(), dr1["Amount"].ToString());
                            row1++;
                        }
                    }
                }
                ...
                if (row1 > 0)
                {
                    ...
                    {
                        sum1 = sum1 + float.Parse(dataGridView1.Rows[k1].Cells[6].Value.ToString());
                    }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (select && dataGridView1.Rows[rowindex1].Cells[1].Value != null)
            {
                ...
                textBox7.Text = dataGridView1.Rows[rowindex1].Cells[2].Value.ToString();
                textBox6.Text = dataGridView1.Rows[rowindex1].Cells[3].Value.ToString();
                textBox2.Text = dataGridView1.Rows[rowindex1].Cells[4].Value.ToString();
                textBox5.Text = dataGridView1.Rows[rowindex1].Cells[5].Value.ToString();
                textBox3.Text = dataGridView1.Rows[rowindex1].Cells[6].Value.ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (select && dataGridView1.Rows[rowindex1].Cells[1].Value != null)
            {
                if (float.Parse(dataGridView1.Rows[rowindex1].Cells[6].Value.ToString()) <= 0)
                {
        ...
        public void CoDD(bool ok, string n)
        {
            if (ok)
            {
                SqlConnection cn111 = new SqlConnection(src);
                SqlCommand cmd111 = new SqlCommand("DELETE FROM [StoreDebt] WHERE Id = @Ird", cn111);
                ...
                cmd.Parameters.AddWithValue("@textBox3", "لقد تم حذف فاتورة مشتريات من الدين" + Environment.NewLine + "  رمز الحركة  " + dataGridView1.Rows[rowindex1].Cells[2].Value.ToString() + "  اسم الشركة  " + dataGridView1.Rows[rowindex1].Cells[4].Value.ToString() + "  التاريخ  " + dataGridView1.Rows[rowindex1].Cells[3].Value.ToString() + "  رقم فاتورة المشتريات  " + dataGridView1.Rows[rowindex1].Cells[5].Value.ToString() + "  القيمة  " + dataGridView1.Rows[rowindex1].Cells[6].Value.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if(textBox11.Text!="")
            {
                ...
                else
                {
                    ...
                    if (float.Parse(textBox9.Text) <= reg1 && float.Parse(textBox9.Text) >= 0)
                    {
                        Program.mysignin.Show();
                        Program.mysignin.Signin_Load(sender, e);
                        string ww = "CoDP";
        ...
        public void CoDP(bool ok, string n)
        {
            if (ok)
            {
                SqlConnection conn5 = new SqlConnection(src);
                SqlCommand cmdn5 = new SqlCommand("UPDATE [StoreDebt] SET Amount=@box3 WHERE Id = '" + textBox11.Text + "'", conn5);
                ...
                while (dr399.Read())
                {
                    if(dr399["Id"].ToString()==textBox7.Text)
                    {
                ...
                SqlCommand cmdn58 = new SqlCommand("UPDATE [Purchases] SET Debt=@box1, Paid=@box2, RDebt=@box3 WHERE Id = '" + int.Parse(textBox7.Text) + "'", conn58);
                if(float.Parse(textBox1.Text)==0)
                {
                ...
                cmd.Parameters.AddWithValue("@textBox1", n);
                cmd.Parameters.AddWithValue("@textBox2", DateTime.Now.ToString());
                cmd.Parameters.AddWithValue("@textBox3", "لقد تم دفع مبلغ لفاتورة مشتريات من الدين" + Environment.NewLine + "  رمز الحركة  " + textBox7.Text + "  اسم الشركه  " + textBox2.Text + "  التاريخ  " + textBox6.Text + "  رقم فاتورة المشتريات  " + textBox5.Text + "  القيمة  " + textBox9.Text + "  المتبقي  " + textBox1.Text);
                cmd.Parameters.AddWithValue("@textBox4", "UP");
                con.Open();
                SqlDataReader dr2 = cmd.ExecuteReader();

                MessageBox.Show("لقد تم دفع المبلغ بنجاح");
                comboBox3.Text = "";
                textBox1.Text = "";
                textBox2.Text = "";
                textBox4.Text = "";
